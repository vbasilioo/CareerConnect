class Login{
    ...
    public void Iniciar(){
        while(true){
            ...
            switch(opcao){
                default:
                    Console.Clear();
                    Console.WriteLine("Você não inseriu uma opção correta, tente novamente!");
                break;
                case "1":
                    Console.Clear();
                    Entrar();
    ...
    public void Entrar(){
        ...
        if(database.Login(usuario, senha) == false){
            Console.Clear();
    ...
    public void CriarConta(){
        ...
        Console.WriteLine("Informe um seu usuário: ");
        string usuario = Console.ReadLine();
    ...
    public void EsqueciMinhaSenha(){
        ...
        if(database.Autenticar(usuario)){
            ...
            Console.WriteLine("O usuário não existe, por favor tente novamente.");
        }
    }
}